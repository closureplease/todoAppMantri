...
footerView:Ember.ContainerView.create({elementId:"footer",tagName:"footer",visibilityBinding:"controller.namespace.entriesController.noneLeft",classNameBindings:["visibility:hidden"],childViews:[Todos.views.Stats.create(),Todos.views.Filters.create(),Todos.views.ClearButton.create()]})});;this.Todos=this.Todos||{};this.Todos.views=this.Todos.views||{};this.Todos.views.Application=Todos.views.Application;}).call(this);

//# sourceMappingURL=/dist/app-module-application.min.js.map
